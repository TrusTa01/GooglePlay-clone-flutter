...
class EventHeroBanner extends StatelessWidget {
  final EventHeroBannerUiModel model;
  final VoidCallback? onTap;

  const EventHeroBanner({super.key, required this.model, this.onTap});
      ...
      child: GestureDetector(
        ...
        child: Stack(
          ...
          children: [
            ...
            if (model.hasTopTooltip && model.topTooltipText != null)
              Positioned(
                top: 16,
                left: 22,
                child: Container(
