...
List<SupportItem> getSupportItems(
  ...
  return [
    SupportItem.link(
      ...
      onTap: () => launchMyUrl(product.developer.websiteUrl),
    ),
    SupportItem.link(
      icon: Icons.email_outlined,
      title: l10n.supportEmail,
      subtitle: product.developer.emailSupport,
      onTap: () => mailTo(email: product.developer.emailSupport),
    ),
    SupportItem.link(
      icon: Icons.shield_outlined,
      title: l10n.supportPrivacy,
      onTap: () => launchMyUrl(product.developer.privacyPolicyUrl),
    ),
    SupportItem.sectionHeader(title: l10n.supportAboutDeveloper),
    SupportItem.infoText(title: product.developer.company),
    SupportItem.infoText(title: product.developer.emailSupport),
    SupportItem.infoText(title: product.developer.address),
    SupportItem.infoText(title: product.developer.city),
    SupportItem.infoText(title: product.developer.country),
    SupportItem.infoText(title: product.developer.phone),
  ];
}
