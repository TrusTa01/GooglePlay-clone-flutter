...
class KidsDetailsScreen extends StatelessWidget {
  ...
  List<Widget Function()> _buildContentBuilders(double screenHeight) {
    return [
      () => Center(
            child: Text(
              'Детям - всё лучшее',
  ...
  Widget build(BuildContext context) {
    ...
    final contentBuilders = _buildContentBuilders(screenHeight);
              ...
              slivers: [
                ...
                SliverPadding(
                  ...
                  sliver: SliverList.builder(
                    itemCount: contentBuilders.length,
                    itemBuilder: (context, index) => contentBuilders[index](),
                  ),
                ),
              ],
            ),
