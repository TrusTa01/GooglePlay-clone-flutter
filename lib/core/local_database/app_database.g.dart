...
class CachedEventBanner extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(bannerId, eventId, eventCategory, eventDescription);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $CachedSectionsTable extends CachedSections
  ...
  static TypeConverter<Map<String, String>?, String?> $convertertitle =
      const LocalizedStringNullableConverter();
  static TypeConverter<Map<String, String>?, String?> $convertersubtitle =
      const LocalizedStringNullableConverter();
}
...
class CachedSection extends DataClass implements Insertable<CachedSection> {
  ...
  factory CachedSection.fromJson(
    ...
    return CachedSection(
      ...
      title: serializer.fromJson<Map<String, String>?>(json['title']),
      subtitle: serializer.fromJson<Map<String, String>?>(json['subtitle']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'title': serializer.toJson<Map<String, String>?>(title),
      'subtitle': serializer.toJson<Map<String, String>?>(subtitle),
  ...
  CachedSection copyWith({
    ...
    String? sectionType,
    Value<Map<String, String>?> title = const Value.absent(),
    Value<Map<String, String>?> subtitle = const Value.absent(),
    String? dataSource,
...
class CachedSectionsCompanion extends UpdateCompanion<CachedSection> {
  ...
  final Value<Map<String, String>?> title;
  final Value<Map<String, String>?> subtitle;
  ...
  CachedSectionsCompanion copyWith({
    ...
    Value<Map<String, String>?>? title,
    Value<Map<String, String>?>? subtitle,
...
final class $$CachedBannersTableReferences
    extends BaseReferences<_$AppDatabase, $CachedBannersTable, CachedBanner> {
  ...
  _cachedEventBannersRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.cachedBanners.id,
          db.cachedEventBanners.bannerId,
        ),
      );

  $$CachedEventBannersTableProcessedTableManager get cachedEventBannersRefs {
    final manager = $$CachedEventBannersTableTableManager(
      $_db,
...
class $$CachedBannersTableFilterComposer
  ...
  Expression<bool> cachedEventBannersRefs(
    ...
    final $$CachedEventBannersTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.cachedEventBanners,
      getReferencedColumn: (t) => t.bannerId,
      builder:
          (
            joinBuilder, {
...
class $$CachedBannersTableAnnotationComposer
  ...
  Expression<T> cachedEventBannersRefs<T extends Object>(
    ...
    final $$CachedEventBannersTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.cachedEventBanners,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CachedBannersTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
...
final class $$CachedEventBannersTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          ...
          CachedEventBanner
        > {
  $$CachedEventBannersTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
...
class $$CachedEventBannersTableTableManager
    extends
        RootTableManager<
          ...
          (CachedEventBanner, $$CachedEventBannersTableReferences),
          CachedEventBanner,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$CachedEventBannersTableReferences(db, table, e),
                ),
              )
              .toList(),
...
class $$CachedSectionsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<Map<String, String>?, String> get subtitle =>
