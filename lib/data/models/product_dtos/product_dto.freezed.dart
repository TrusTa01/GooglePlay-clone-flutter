...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,id,title,creator,shortDescription,description,rating,reviewsCount,releaseDate,iconUrl,isPaid,price,currencyCode,discountPrice,const DeepCollectionEquality().hash(tags),creatorDescription,url,const DeepCollectionEquality().hash(categories));
...
@useResult
$Res call({
 String type, String id, String title, String creator, String shortDescription, String description, double rating, int reviewsCount, DateTime releaseDate, String iconUrl, bool isPaid, double? price, String currencyCode, double? discountPrice, List<String> tags, String creatorDescription, String url,@JsonKey(name: 'gameGenre') List<String> categories
});
...
class AppDto implements ProductDto {
  const AppDto({this.type = 'app', required this.id, required this.title, required this.creator, required this.shortDescription, required this.description, required this.rating, required this.reviewsCount, required this.releaseDate, required this.iconUrl, required this.isPaid, this.price, this.currencyCode = 'USD', this.discountPrice, this.technicalInfo, required this.containsAds, required this.containsPaidContent, required this.version, required this.size, this.eventText, required this.whatsNewText, required this.downloadCount, required this.ageRating, required this.isKidsFriendly, required final  List<String> ageRatingReasons, required final  List<String> permissions, required this.lastUpdated, required final  List<String> screenshots, required final  List<String> tags, required this.websiteUrl, required this.emailSupport, required this.privacyPolicyUrl, required this.creatorDescription, required this.url, required this.developerCompany, required this.developerAddress, required this.developerCity, required this.developerCountry, required this.developerPhone, @JsonKey(name: 'appCategory') required final  List<String> categories, this.minAndroidVersion, this.installsRange}): _ageRatingReasons = ageRatingReasons,_permissions = permissions,_screenshots = screenshots,_tags = tags,_categories = categories;
