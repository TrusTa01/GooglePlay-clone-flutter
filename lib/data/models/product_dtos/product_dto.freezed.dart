...
mixin _$ProductDto {
 ...
 String get type; String get id; String get title; String get creator; String get shortDescription; String get description; double get rating; int get reviewsCount; DateTime get releaseDate; String get iconUrl; bool get isPaid; double? get price; List<String> get tags; String get creatorDescription; String get url;@JsonKey(name: 'gameGenre')@JsonKey(name: 'appCategory') List<String> get categories;
...
@useResult
$Res call({
 String type, String id, String title, String creator, String shortDescription, String description, double rating, int reviewsCount, DateTime releaseDate, String iconUrl, bool isPaid, double? price, List<String> tags, String creatorDescription, String url,@JsonKey(name: 'gameGenre') List<String> categories
});
